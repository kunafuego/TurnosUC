...
usuarios = Usuario.create([{nombre: "Juan Perez",
                            email: "pa@uc.cl",
                            calle: "Av. Andres Bello",
                            comuna: "Providencia",
                            numero: 1234,
                            telefono: "78728458",
...
usuario_admin = Usuario.create(
    ...
    imagen: "https://img.freepik.com/foto-gratis/hermoso-arreglo-papel-tapiz-flores_23-2149057015.jpg?w=2000",
    password: "123456",
    password_confirmation: "123456"
)
usuario_admin.add_role :admin
